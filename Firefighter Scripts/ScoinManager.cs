...
public class ScoinManager : MonoBehaviour
{
    ...
    IEnumerator SetupBoardServices()
    {
        ...
        {
            GameManager.instance.SetGameSettingsLoaded(true);
        }
    }
    ...
    IEnumerator PassStartingData()
    {
        ...
        string dataToEncrypt = "gameId=19&sendTime=" + unixTime;
    ...
    IEnumerator UpdateScoins(int scoinAmount, string description)
    {
        ...
        string dataToEncrypt = "gameId=19&scoinAmount=" + scoinAmount + "&description=" + description + "&sessionId=" + sessionIDResults.sessionId + "&sendTime=" + unixTime;
        string urlEncryptedData = encryptMaster.Encrypt(dataToEncrypt);
        ...
        if (GameManager.instance != null)
        {
            encryptedGoalsEarnedData = encryptMaster.Encrypt(GameManager.instance.GetFlamesHitAsString());
    ...
    IEnumerator GetPrizeList()
    {
        ...
        string url = "/TestSmartClub/GameApiAction.do?action=getPrizeList&gameId=19";
        //string url = "/SmartClub/GameApiAction.do?action=getPrizeList&gameId=19";
    ...
    {
        string url = "/TestSmartClub/GameApiAction.do?action=getStaticCostPrice&gameId=19";
        //string url = "/SmartClub/GameApiAction.do?action=getStaticCostPrice&gameId=19";
